...
def reverse_bits(n):
    """ Similar to 7- Reverse Integer. However, instead of using modulo and division by 10, we use bit manipulation.
        ...
        Shit 1 bit to right == divide by 2
        Bit & 1 == determine if bit is 0 or 1
        ...
        2nd line in the loop: we shift bits of our initial number n to the right, since we've already checked the last
        bit of n, so we just move on to the next bit.
