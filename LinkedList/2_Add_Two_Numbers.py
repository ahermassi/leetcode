...
def add_two_numbers(l1, l2):
    """ A singly linked list whose nodes contain digits can be viewed as an integer, with the least significant digit
        ...
        A key nuance of the computation is handling the carry. Keep track of the carry using a variable and simulate
        ...
        which are the heads of l1 and l2. Since each digit is in the range of 0..9, summing two digits may "overflow".
        ...
        The algorithm continues processing the input until both lists are exhausted and there is no remaining carry.
