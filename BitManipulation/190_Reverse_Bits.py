...
def reverse_bits(n):
    """ Similar to 7- Reverse Integer. However, instead of using modulo and division by 10, we use bit manipulation.
        ...
        1st line in the loop: n & 1, we check if last bit of n is set, is it 1 or 0; ans << 1 shifts all bits that we
        ...
        So, in our example, we're gonna work on only the first 5 right bits, since other bits are 0.
        ...
        leads to 11001000000000000000000000000000.
    Time complexity: O(1)
